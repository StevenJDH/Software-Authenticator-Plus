...
/**
* Java Server side class for Google Authenticator's TOTP generator which implements the TOTP algorithm (specified in RFC 6238).
...
* @see https://github.com/wstrange/GoogleAuth where this class came from. Modified to use our own Base32 class and not import org.apache.commons.codec.binary.Base32;.
...
/**
 *
 * @author (Modified by) Steven Jenkins De Haro
 */
public class GoogleTOTP {
    ...
    */
    public static String generateSecretKey() {
        ...
        //Base32 codec = new Base32(); This is for org.apache.commons.codec.binary.Base32; which we don't need anymore as we handle it ourself now----------------------------------------------------------------
        byte[] secretKey = Arrays.copyOf(buffer, secretSize);
         //byte[] bEncodedKey = codec.encode(secretKey); This is for org.apache.commons.codec.binary.Base32; which we don't need anymore as we handle it ourself now with the line below--------------------------
        byte[] bEncodedKey = Base32String.encode(secretKey).getBytes();String encodedKey = new String(bEncodedKey);
        return encodedKey;
    }
    ...
    */
    public boolean check_code(String secret, long code, long timeMsec) {
        byte[] decodedKey;
        try {
            decodedKey = Base32String.decode(secret);
