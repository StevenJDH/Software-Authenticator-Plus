...
public class PasscodeGenerator {
  ...
  private final PasscodeGenerator.Signer signer;
  ...
  public PasscodeGenerator(final Mac mac, int passCodeLength, int interval) {
    this(new PasscodeGenerator.Signer() {
      @Override
  ...
  public PasscodeGenerator(PasscodeGenerator.Signer signer, int passCodeLength, int interval) {
    this.signer = signer;
  ...
  private PasscodeGenerator.IntervalClock clock = new PasscodeGenerator.IntervalClock() {
    /*
